...
var source = [
  'var', [ 'create crush button', 'function', [
    'create button', ['crush', 'I have a crush on this person.'],
    'on click', ['crush', 'function', [
      'create connection', []
    ]]
  ]],
  'on screen name profile' , [
    'when viewed by other', ['create crush button', []],
    'when viewing other',   ['create crush button', []],
  ],
  'after create crush', ['function', [
    'delay, then notify initiator', ['1 H']
  ]]
];
